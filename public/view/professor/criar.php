        ...
        <div class="grid-item-content">
            ...
            <div id='gruposTodos'>
                <?php foreach ($disciplinas as $disciplina) { ?>
                    <input class="checkbox" type='checkbox' id="disciplinas" name="disciplinas[]" value="<?php echo $disciplina->id ?>"> <?php echo $disciplina->nome ?>
                    <br>
                <?php } ?>
            </div>
            <br>
            ...
            <div id='gruposTodos'>
                <?php foreach ($salas as $sala) { ?>
                    <input class="checkbox" type='checkbox' id="salas" name="salas[]" value="<?php echo $sala->id ?>"> <?php echo $sala->nome ?>
                    <br>
                <?php } ?>
            </div>
            <br>
